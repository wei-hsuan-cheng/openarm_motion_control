...
public:
    ...
    static std::vector<PosQuat> ScrewMotionPath(const PosQuat& pos_quat_b_e, const PosQuat& pos_quat_e_e_cmd, int N) {
    ...
    static std::pair<std::vector<PosQuat>, std::vector<double>> ScrewMotionTraj(const PosQuat& pos_quat_b_e, const PosQuat& pos_quat_e_e_cmd, int N, double T) {
        std::vector<PosQuat> waypoints; // Output waypoints
