...
#     # NOTE: this reads default_yaml directly; if you want to honor yaml_path, switch to OpaqueFunction.
...
#     # Use lists for array-typed params (even if single value)
#     motion_params = {
#         "rate_hz": 200.0,          # double
#         "offset_rad": [0.0],       # double[]
#         "amplitude_rad": [0.35],   # double[]
#         "frequency_hz": [0.10],    # double[]
#         "phase_rad": [0.0],        # double[]
#     }
